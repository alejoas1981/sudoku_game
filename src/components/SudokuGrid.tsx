            ...
            <div className="grid grid-cols-9 h-full">
                {grid.map((row, rowIndex) =>
                    row.map((cell, colIndex) => {
                        const isNumberHighlighted = highlightedNumber !== null && highlightedNumber !== 0 && cell === highlightedNumber;
                            ...
                            <div
                                ...
                                className={cn(
                                    "sudoku-cell cursor-pointer text-center select-none",
                                    {
                                        ...
                                        'highlight-row-col': isRowColHighlighted(rowIndex, colIndex),
                                        'highlight-number': isNumberHighlighted,
